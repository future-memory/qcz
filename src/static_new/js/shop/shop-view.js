	...
	$(function () {
	    ...
	    Vue.component('order', {
	        ...
	        methods: {
	            ...
	            // 显示地址填写控件
	            showAddressEditor: function showAddressEditor() {
	                var _this = this;
	    ...
	    Vue.component('address-form', {
	        ...
	        methods: {
	            ...
	            // 对当前项做验证
	            validateIt: function validateIt(vm) {
	    ...
	    window.MainVM = new Vue({
	        ...
	        events: {
	            // 显隐订单编辑页
	            'orderToggle': function orderToggle(msg) {
	                var _this = this;
	                _this.orderShow = msg;
	                if (msg) {
	            ...
	            // 显隐地址编辑页
	            'editorToggle': function editorToggle(msg) {
	                var _this = this;
	            ...
	            'allPassed': function allPassed(msg) {
	                this.allPassed = msg;
	            }
	        },
